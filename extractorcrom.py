...
parser.add_argument('directory', metavar='dir', type=str, nargs='+', help="Directorio donde se encuentran los cromatogramas en formato pdf")
parser.add_argument('output', metavar='out', type=str, nargs='+', help="Archivo de salida con los valores en formato csv")
...
for i in tqdm(onlycrop):
	...
	out = out[out.Component.str[0].isin(['C', '1'])]
	out=out[out.Component.str[1]!='o']
